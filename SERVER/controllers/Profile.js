...
exports.updateProfile = async (req, res) => {
	try {
		// dateOfBirth = "": This sets dateOfBirth to an empty string ("") if req.body.dateOfBirth is not defined or is undefined
		const { firstName,lastName,dateOfBirth = "", about = "", contactNumber } = req.body;
