...
import { featchCourseDetails } from '../services/operations/courseDetailsAPI';
...
const CourseDetails = () => {
    ...
    useEffect(()=>{
        const getCourseFullDetails= async()=>{
            try{
                const responce=await featchCourseDetails(courseId);
                console.log("Print courseDetail ",responce);
                setCourseData(responce);
            }
            catch(error){
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap justify-between gap-2">
                <div className="flex gap-2">
                  ...
                  <span>{courseData[0].totalDuration} total length</span>
                </div>
                <div>
                  <button
